...
var client_references_default = {
	...
	"470a5853ae44": async () => {
		const m = await import("./assets/ContentSectionLinks-DFZ7E-xZ.js");
	...
	"8e4e3b328937": async () => {
		const m = await import("./assets/ContentFaqList-6es5Ph_y.js");
	...
	"b76ca7f8db73": async () => {
		const m = await import("./assets/ContentPrimaryAction-CL46qD1F.js");
