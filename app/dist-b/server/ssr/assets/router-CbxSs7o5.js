import { D as __toESM, _ as toSameOriginAppPath, g as toBrowserNavigationHref, m as isHashOnlyBrowserUrlChange, w as stripBasePath, x as require_react } from "../index.js";
import { a as getDomainLocaleUrl, i as addLocalePrefix, n as appendSearchParamsToUrl, r as urlQueryToSearchParams, t as addQueryParam } from "./link-nDlMGg24.js";
...
async function navigateClient(url) {
	...
	try {
		...
		const React = (await import("../index.js").then((n) => /* @__PURE__ */ __toESM(n.x(), 1))).default;
		assertStillCurrent();
