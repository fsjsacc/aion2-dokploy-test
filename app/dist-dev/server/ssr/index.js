...
var client_references_default = {
	"009ec46bb0c1": async () => {
		const m = await import("./assets/AdminDashboard-CEd8w5v2.js");
		return { get "AdminDashboard"() {
			return m["AdminDashboard"];
		} };
	},
	"137142865fce": async () => {
		const m = await import("./assets/GlobalStyles-Bau_-Qbp.js");
		return { get "GlobalStyles"() {
			return m["GlobalStyles"];
		} };
	},
	"14b6a051c341": async () => {
	...
	"35e5e4b89036": async () => {
		const m = await import("./assets/AdminEmailLogin-DfRZBfCH.js");
	...
	"43d117a16416": async () => {
		const m = await import("./assets/ProvenancePanel-DV8PkXZO.js");
		return { get "ProvenancePanel"() {
			return m["ProvenancePanel"];
		} };
	},
	"470a5853ae44": async () => {
		const m = await import("./assets/ContentSectionLinks-BYp0kGFA.js");
		return { get "ContentSectionLinks"() {
			return m["ContentSectionLinks"];
		} };
	},
	"589071c1af49": async () => {
	...
	"6bbedbfc36f3": async () => {
		const m = await import("./assets/CopyCodeButton-2jfY9yCf.js");
		return { get "CodeRevealControl"() {
			return m["CodeRevealControl"];
		} };
	},
	"776ab720a8fe": async () => {
		const m = await import("./assets/DeferredAnalyticsConsentManager-CfQgmHzp.js");
	...
	"8e4e3b328937": async () => {
		const m = await import("./assets/ContentFaqList-CVH9st-e.js");
		return { get "ContentFaqList"() {
			return m["ContentFaqList"];
		} };
	},
	"a4779745ddcd": async () => {
	...
	"a6a6ce469bc6": async () => {
		const m = await import("./assets/ToolDirectory-DoOp4QJJ.js");
		return { get "ToolDirectory"() {
			return m["ToolDirectory"];
		} };
	},
	"a9381909f7a5": async () => {
		const m = await import("./assets/OfficialItemDetail-Cik23oSn.js");
		return { get "OfficialItemDetail"() {
			return m["OfficialItemDetail"];
		} };
	},
	"aa585ee79f19": async () => {
		const m = await import("./assets/ItemCatalog-DCXOaC0O.js");
	...
	"b142e7968e0b": async () => {
		const m = await import("./assets/EventTimer-3x8-U42C.js");
		return { get "EventTimer"() {
			return m["EventTimer"];
		} };
	},
	"b76ca7f8db73": async () => {
		const m = await import("./assets/ContentPrimaryAction-BN6YQjdd.js");
		return { get "ContentPrimaryAction"() {
			return m["ContentPrimaryAction"];
		} };
	},
	"bce310781cd9": async () => {
		const m = await import("./assets/ClassFinder-DLiQ-tsO.js");
	...
	"d2d367d20af3": async () => {
		const m = await import("./assets/HomeTrackedLink-t8Qhu0zT.js");
		return { get "HomeTrackedLink"() {
			return m["HomeTrackedLink"];
		} };
	},
	"dcea451d0c3b": async () => {
		const m = await import("./assets/FeedbackReportDialog-J-fE3fk3.js").then((n) => n.n);
		return { get "FeedbackReportDialog"() {
			return m["FeedbackReportDialog"];
		} };
	},
	"e4ac87053a12": async () => {
		const m = await import("./assets/DailyChecklist-iFvLgzmH.js");
		return { get "DailyChecklist"() {
			return m["DailyChecklist"];
		} };
	},
	"eb0432ad33e0": async () => {
		const m = await import("./assets/CraftingDirectory-BNRDC42E.js");
		return { get "CraftingDirectory"() {
			return m["CraftingDirectory"];
		} };
	},
	"eddc436c7e1d": async () => {
		const m = await import("./assets/MaterialCalculator-BO14syCO.js");
		return { get "MaterialCalculator"() {
			return m["MaterialCalculator"];
		} };
	},
	"fb322e7b1b12": async () => {
		const m = await import("./assets/GlobalLaunchCountdown-C1I4f6F9.js");
