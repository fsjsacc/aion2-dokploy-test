import { C as hasBasePath, E as __toESM, S as VINEXT_MOUNTED_SLOTS_HEADER, _ as toSameOriginAppPath, a as getMountedSlotsHeader, b as AppElementsWire, c as prefetchRscResponse, f as createRscRequestHeaders, g as toBrowserNavigationHref, h as resolveRelativeHref, n as require_jsx_runtime, o as getPrefetchedUrls, p as createRscRequestUrl, r as getCurrentInterceptionContext, s as navigateClientSide, v as withBasePath$1, w as stripBasePath, x as require_react, y as isDangerousScheme } from "../index.js";
...
var Link = (0, import_react.forwardRef)(function Link({ href, as, replace = false, prefetch: prefetchProp, scroll = true, children, onClick, onMouseEnter, onTouchStart, onNavigate, ...rest }, forwardedRef) {
	...
	const handleClick = async (e) => {
		...
		if (typeof window.__VINEXT_RSC_NAVIGATE__ === "function") {
			...
			const Router = (await import("./router-BImSstYz.js")).default;
